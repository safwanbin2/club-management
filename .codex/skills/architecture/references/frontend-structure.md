...
When this repo contains `docs/design/`, use it before composing page UI:

- Read `docs/ui-system.md`.
- Read `docs/design/stitch-source.md`, `docs/design/page-map.md`, and `docs/design/implementation-notes.md`.
- Inspect the closest desktop and mobile screenshots under `docs/design/stitch-export/`.
- If there is no exact design, derive the page from the closest existing Stitch reference before inventing a new pattern.
- Use `code.html` only for structural clues. Rebuild the page with React, Ant Design, Tailwind, and this page-slice structure.
