---
name: bit-crm-mern-architecture
description: >
...
4. For backend/API/database work, read [references/backend-structure.md](references/backend-structure.md).
5. For new full-stack features, read [references/feature-blueprint.md](references/feature-blueprint.md) after the relevant setup/frontend/backend reference.
